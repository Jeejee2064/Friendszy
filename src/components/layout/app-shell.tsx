...
export async function AppShell({
  ...
  return (
    <div className="flex min-h-screen bg-bg">
      <aside className="flex w-16 shrink-0 flex-col border-r border-border bg-card py-4 md:w-64">
        <Link
          href="/"
        ...
        >
          ...
          />
          <span className="hidden font-pacifico text-xl text-teal2 md:inline">
            Friendszy
          </span>
        </Link>
